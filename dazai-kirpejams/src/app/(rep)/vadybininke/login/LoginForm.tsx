    ...
    <div className="min-h-screen bg-[#1A1A1A] flex items-center justify-center p-5">
      <div className="w-full max-w-[420px] bg-white rounded-2xl px-10 py-12 shadow-[0_20px_60px_rgba(0,0,0,0.4)]">
        ...
        <form action={formAction} className="space-y-5">
          <div>
            <label htmlFor="email" className="block text-[13px] font-semibold text-brand-gray-900 mb-1.5">
              El. paštas
            </label>
            <input
              type="email"
          ...
          <div>
            <label htmlFor="password" className="block text-[13px] font-semibold text-brand-gray-900 mb-1.5">
              Slaptažodis
            </label>
            <input
              type="password"
        ...
        <Link href="/" className="block text-center text-[13px] text-brand-gray-500 hover:text-brand-magenta transition-colors">
          Grįžti į svetainę
        </Link>
      </div>
    </div>
