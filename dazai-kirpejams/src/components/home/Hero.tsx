...
/**
 * Hero atkurtas iš originalaus HTML dizaino:
 *  - gradientinis fonas nuo balto iki šviesiai pilkos
 *  - magenta pill "badge" su žvaigždute
 *  - h1 su "kirpėjams" .highlight span (magenta)
 *  - dešinėje — produkto vaizdas su 180 ml apskritimu ir kainos kortele
 */
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-[60px] items-center">
          ...
          <div className="max-w-[540px] text-center lg:text-left order-2 lg:order-1">
            <div className="inline-flex items-center gap-1.5 bg-brand-magenta/[0.08] text-brand-magenta px-4 py-2 rounded-full text-sm font-semibold mb-6">
              ...
              <span>Color SHOCK &amp; Pasirinkimas iš 50 spalvų</span>
            </div>
            ...
            <p className="text-[1.15rem] leading-[1.7] text-brand-gray-500 mb-9">
              {hero.subtitle} Profesionali formulė, plati spalvų paletė ir
              ekonomiška kaina — viskas, ko reikia Jūsų salonui.
            </p>
          ...
          {/* Dešinė pusė — produkto vaizdas su float elementais */}
          <div className="relative flex items-center justify-center order-1 lg:order-2">
            <div className="relative w-full max-w-[360px] lg:max-w-[680px] aspect-[3/4] rounded-xl overflow-hidden">
              {/* Placeholder vizualas — kai bus produkto PNG, pakeisime į next/image */}
