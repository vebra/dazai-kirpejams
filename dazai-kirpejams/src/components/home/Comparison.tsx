        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-[60px] items-center">
          ...
          <div>
            ...
            <Link
              ...
              className="mt-8 inline-flex items-center justify-center gap-2 px-8 py-[14px] btn-shine bg-brand-gradient text-white rounded-lg font-semibold hover:brightness-110 hover:-translate-y-0.5 hover:shadow-[0_4px_16px_rgba(233,30,140,0.3)] transition-all"
            >
              {t.ctaFull} →
            </Link>
          </div>
