      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_1fr] gap-10 items-center">
          <div>
            ...
            <Link
              href={detailHref}
              className="inline-flex items-center justify-center gap-2 px-9 py-[16px] btn-shine bg-brand-gradient text-white rounded-lg text-[1.05rem] font-semibold hover:brightness-110 hover:-translate-y-0.5 hover:shadow-[0_4px_16px_rgba(233,30,140,0.4)] transition-all"
            >
