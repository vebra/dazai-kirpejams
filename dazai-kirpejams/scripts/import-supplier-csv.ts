  ...
  if (category === 'dazai') {
    ...
    return {
      ...
      payload: {
        ...
        sku,
        category_slug: 'dazai',
        name_lt: `Color SHOCK ${dye.num ?? dye.name_en} — ${dye.name_lt}`,
        name_en: `Color SHOCK ${dye.num ?? dye.name_en} — ${dye.name_en}`,
        name_ru: `Color SHOCK ${dye.num ?? dye.name_en} — ${dye.name_ru}`,
